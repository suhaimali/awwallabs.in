@extends('layouts.app')
@section('title', ' | Daily Collection Locked')
...
<div class="d-flex justify-content-center align-items-center" style="min-height: 70vh;">
    <div class="card border-0 shadow-sm" style="max-width: 400px; width: 100%; border-radius: 16px; background: #ffffff;">
        <div class="card-body p-4 text-center">
            ...
            <p style="font-size: 14px; color: var(--text-muted); margin-bottom: 24px;">Please enter the administrator password to view the Daily Collection summary.</p>
